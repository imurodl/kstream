...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <h1 class="text-2xl sm:text-3xl font-bold text-white mb-6">My Watchlist</h1>
    ...
    <div v-if="watchlistStore.items.length === 0" class="text-center py-20">
      ...
      <p class="text-gray-400 text-lg mb-2">Your watchlist is empty</p>
      <p class="text-gray-600 text-sm mb-6">Browse shows and add them to your watchlist.</p>
      <RouterLink
        to="/browse"
