      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <a href="https://github.com/imurodl" target="_blank" rel="noopener" class="text-sm text-gray-500 hover:text-purple-400 transition-colors flex items-center gap-1.5">
